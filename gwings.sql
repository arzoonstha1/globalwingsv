...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 14, 2018 at 02:12 PM
...
(15, '2018_03_12_052105_create_verifications', 3);
...
(2, 'About', 'about', '2018-03-10 06:56:38', '2018-03-12 05:00:21'),
...
(5, 'Contact', 'contact', '2018-03-10 06:57:28', '2018-03-12 05:00:29'),
(6, 'Verification', 'verification', '2018-03-10 22:54:47', '2018-03-10 22:54:47'),
(7, 'Courses', 'course', '2018-03-11 23:15:30', '2018-03-11 23:15:30');
...
(5, 'Flight Attendent', 'flightattendent', 7, '<ul><li>Aviation general knowledge</li><li>Introduction and regulatory overview&nbsp;</li><li>Air-craft specifications</li><li>AVESEC(Aviation Security)</li><li>Inflight service procedure</li><li>Survival</li><li>Basic aeronautical knowledge</li><li>Aviation terminology and phonetics</li><li>Aircraft general knowledge</li><li>Theory of flights</li><li>Aircraft emergency situations and Evacuation procedure</li><li>Food and Beverage service procedures and Table manners training.</li><li>Conversation skills on board</li><li>Team building activities</li><li>Aircraft emergency equipment and their use</li><li>Use of intercome/P.A. system.</li></ul>', '1520919077-Screenshot (16).png', 'active', '2018-03-12 23:46:18', '2018-03-12 23:46:18');
...
CREATE TABLE `verifications` (
  `id` int(10) UNSIGNED NOT NULL,
  `symbolnumber` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `verifications` (`id`, `symbolnumber`, `name`, `issued`, `created_at`, `updated_at`) VALUES
(1, '12345', 'Amrendra  bahubali', '2018-12-31', '2018-03-12 00:10:58', '2018-03-12 00:16:04');
...
ALTER TABLE `verifications`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `verifications_symbolnumber_unique` (`symbolnumber`);
